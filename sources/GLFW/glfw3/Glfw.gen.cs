...
public unsafe partial class Glfw : IGlfw, IGlfw.Static
{
    public partial class DllImport : IGlfw.Static
    {
        ...
        public static PtrRef<Cursor, Cursor> CreateCursor(
        ...
        )
        {
            fixed (Image* __dsl_image = image)
            {
                ...
                return __DSL_glfwCreateCursor((Image*)__dsl_image, (int)xhot, (int)yhot);
            }
        }
        ...
        public static PtrRef<Cursor, Cursor> CreateStandardCursor(int shape)
        {
            ...
            return __DSL_glfwCreateStandardCursor((int)shape);
        }
        ...
        public static PtrRef<Window, Window> CreateWindow(
            int width,
            int height,
        ...
        public static void DestroyCursor(PtrRef<Cursor, Cursor> cursor)
        {
            fixed (Cursor* __dsl_cursor = cursor)
            {
                ...
                __DSL_glfwDestroyCursor((Cursor*)__dsl_cursor);
            }
        }
        ...
        public static void DestroyWindow(PtrRef<Window, Window> window)
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                __DSL_glfwDestroyWindow((Window*)__dsl_window);
            }
        }
        ...
        )
        {
            fixed (sbyte* __dsl_extension = extension)
            {
                ...
                return __DSL_glfwExtensionSupported((sbyte*)__dsl_extension);
            }
        }
        ...
        public static PtrRefToConst<sbyte, sbyte> GetClipboardString(PtrRef<Window, Window> window)
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                return __DSL_glfwGetClipboardString((Window*)__dsl_window);
            }
        }
        ...
        public static PtrRef<Window, Window> GetCurrentContext()
        {
        ...
        {
            fixed (PtrToConst<sbyte, sbyte>* __dsl_description = description)
            {
                ...
                return __DSL_glfwGetError((sbyte**)__dsl_description);
            }
        }
        ...
        public static int GetGamepadState(int jid, PtrRef<Gamepadstate, Gamepadstate> state)
        {
            fixed (Gamepadstate* __dsl_state = state)
            {
                ...
                return __DSL_glfwGetGamepadState((int)jid, (Gamepadstate*)__dsl_state);
            }
        }
        ...
        public static PtrRefToConst<Gammaramp, Gammaramp> GetGammaRamp(
            PtrRef<Monitor, Monitor> monitor
        )
        {
            fixed (Monitor* __dsl_monitor = monitor)
            {
                ...
                return __DSL_glfwGetGammaRamp((Monitor*)__dsl_monitor);
            }
        }
        ...
        public static int GetInputMode(PtrRef<Window, Window> window, int mode)
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                return __DSL_glfwGetInputMode((Window*)__dsl_window, (int)mode);
            }
        }
        ...
        public static PtrRefToConst<float, float> GetJoystickAxes(int jid, PtrRef<int, int> count)
        {
            fixed (int* __dsl_count = count)
            {
                ...
                return __DSL_glfwGetJoystickAxes((int)jid, (int*)__dsl_count);
            }
        }
        ...
        public static PtrRefToConst<byte, byte> GetJoystickButtons(int jid, PtrRef<int, int> count)
        {
            fixed (int* __dsl_count = count)
            {
                ...
                return __DSL_glfwGetJoystickButtons((int)jid, (int*)__dsl_count);
            }
        }
        ...
        public static PtrRefToConst<byte, byte> GetJoystickHats(int jid, PtrRef<int, int> count)
        {
            fixed (int* __dsl_count = count)
            {
                ...
                return __DSL_glfwGetJoystickHats((int)jid, (int*)__dsl_count);
            }
        }
        ...
        public static PtrRef GetJoystickUserPointer(int jid)
        {
            ...
            return __DSL_glfwGetJoystickUserPointer((int)jid);
        }
        ...
        public static int GetKey(PtrRef<Window, Window> window, int key)
        {
            fixed (Window* __dsl_window = window)
            {
                [DllImport("glfw", ExactSpelling = true, EntryPoint = "glfwGetKey")]
                static extern int __DSL_glfwGetKey(Window* window, int key);
                return __DSL_glfwGetKey((Window*)__dsl_window, (int)key);
            }
        }
        ...
        )
        {
            ...
            fixed (Monitor* __dsl_monitor = monitor)
            {
                ...
                __DSL_glfwGetMonitorContentScale(
                    (Monitor*)__dsl_monitor,
                    (float*)__dsl_xscale,
                    (float*)__dsl_yscale
                );
        ...
        public static PtrRefToConst<sbyte, sbyte> GetMonitorName(PtrRef<Monitor, Monitor> monitor)
        {
            fixed (Monitor* __dsl_monitor = monitor)
            {
                ...
                return __DSL_glfwGetMonitorName((Monitor*)__dsl_monitor);
            }
        }
        ...
        )
        {
            ...
            fixed (Monitor* __dsl_monitor = monitor)
            {
                ...
                __DSL_glfwGetMonitorPhysicalSize(
                    (Monitor*)__dsl_monitor,
                    (int*)__dsl_widthMM,
                    (int*)__dsl_heightMM
                );
        ...
        public static PtrRef<Ptr<Monitor, Monitor>, Monitor> GetMonitors(PtrRef<int, int> count)
        {
            fixed (int* __dsl_count = count)
            {
                [DllImport("glfw", ExactSpelling = true, EntryPoint = "glfwGetMonitors")]
                static extern Monitor** __DSL_glfwGetMonitors(int* count);
                return __DSL_glfwGetMonitors((int*)__dsl_count);
            }
        }
        ...
        public static PtrRef GetMonitorUserPointer(PtrRef<Monitor, Monitor> monitor)
        {
            fixed (Monitor* __dsl_monitor = monitor)
            {
                ...
                return __DSL_glfwGetMonitorUserPointer((Monitor*)__dsl_monitor);
            }
        }
        ...
        public static int GetMouseButton(PtrRef<Window, Window> window, int button)
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                return __DSL_glfwGetMouseButton((Window*)__dsl_window, (int)button);
            }
        }
        ...
        public static PtrRef<Monitor, Monitor> GetPrimaryMonitor()
        {
        ...
        )
        {
            fixed (sbyte* __dsl_procname = procname)
            {
                ...
                return __DSL_glfwGetProcAddress((sbyte*)__dsl_procname);
            }
        }
        ...
        public static PtrRefToConst<PtrToConst<sbyte, sbyte>, sbyte> GetRequiredInstanceExtensions(
        ...
        )
        {
            fixed (uint* __dsl_count = count)
            {
                ...
                return __DSL_glfwGetRequiredInstanceExtensions((uint*)__dsl_count);
            }
        }
        ...
        )
        {
            ...
            fixed (int* __dsl_major = major)
            {
                ...
                __DSL_glfwGetVersion((int*)__dsl_major, (int*)__dsl_minor, (int*)__dsl_rev);
            }
        }
        ...
        public static PtrRefToConst<sbyte, sbyte> GetVersionString()
        {
        ...
        public static PtrRefToConst<Vidmode, Vidmode> GetVideoMode(PtrRef<Monitor, Monitor> monitor)
        {
            fixed (Monitor* __dsl_monitor = monitor)
            {
                ...
                return __DSL_glfwGetVideoMode((Monitor*)__dsl_monitor);
            }
        }
        ...
        public static PtrRefToConst<Vidmode, Vidmode> GetVideoModes(
            PtrRef<Monitor, Monitor> monitor,
        ...
        )
        {
            ...
            fixed (Monitor* __dsl_monitor = monitor)
            {
                ...
                return __DSL_glfwGetVideoModes((Monitor*)__dsl_monitor, (int*)__dsl_count);
            }
        }
        ...
        public static int GetWindowAttrib(PtrRef<Window, Window> window, int attrib)
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                return __DSL_glfwGetWindowAttrib((Window*)__dsl_window, (int)attrib);
            }
        }
        ...
        )
        {
            ...
            fixed (Window* __dsl_window = window)
            {
                ...
                __DSL_glfwGetWindowContentScale(
                    (Window*)__dsl_window,
                    (float*)__dsl_xscale,
                    (float*)__dsl_yscale
                );
        ...
        public static PtrRef<Monitor, Monitor> GetWindowMonitor(PtrRef<Window, Window> window)
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                return __DSL_glfwGetWindowMonitor((Window*)__dsl_window);
            }
        }
        ...
        public static float GetWindowOpacity(PtrRef<Window, Window> window)
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                return __DSL_glfwGetWindowOpacity((Window*)__dsl_window);
            }
        }
        ...
        )
        {
            ...
            fixed (Window* __dsl_window = window)
            {
                ...
                __DSL_glfwGetWindowPos((Window*)__dsl_window, (int*)__dsl_xpos, (int*)__dsl_ypos);
            }
        }
        ...
        public static PtrRef GetWindowUserPointer(PtrRef<Window, Window> window)
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                return __DSL_glfwGetWindowUserPointer((Window*)__dsl_window);
            }
        }
        ...
        )
        {
            fixed (Allocator* __dsl_allocator = allocator)
            {
                ...
                __DSL_glfwInitAllocator((Allocator*)__dsl_allocator);
            }
        }
        ...
        public static void MakeContextCurrent(PtrRef<Window, Window> window)
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                __DSL_glfwMakeContextCurrent((Window*)__dsl_window);
            }
        }
        ...
        public static void RequestWindowAttention(PtrRef<Window, Window> window)
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                __DSL_glfwRequestWindowAttention((Window*)__dsl_window);
            }
        }
        ...
        )
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                return __DSL_glfwSetCharCallback(
                    (Window*)__dsl_window,
                    (delegate* unmanaged<Window*, uint, void>)callback
                );
            }
        ...
        )
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                return __DSL_glfwSetCharModsCallback(
                    (Window*)__dsl_window,
                    (delegate* unmanaged<Window*, uint, int, void>)callback
                );
            }
        ...
        )
        {
            ...
            fixed (Window* __dsl_window = window)
            {
                ...
                __DSL_glfwSetClipboardString((Window*)__dsl_window, (sbyte*)__dsl_string);
            }
        }
        ...
        public static void SetCursor(PtrRef<Window, Window> window, PtrRef<Cursor, Cursor> cursor)
        {
            fixed (Cursor* __dsl_cursor = cursor)
            fixed (Window* __dsl_window = window)
            {
                ...
                __DSL_glfwSetCursor((Window*)__dsl_window, (Cursor*)__dsl_cursor);
            }
        }
        ...
        )
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                return __DSL_glfwSetCursorEnterCallback(
                    (Window*)__dsl_window,
                    (delegate* unmanaged<Window*, int, void>)callback
                );
            }
        ...
        public static void SetCursorPos(PtrRef<Window, Window> window, double xpos, double ypos)
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                __DSL_glfwSetCursorPos((Window*)__dsl_window, (double)xpos, (double)ypos);
            }
        }
        ...
        )
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                return __DSL_glfwSetCursorPosCallback(
                    (Window*)__dsl_window,
                    (delegate* unmanaged<Window*, double, double, void>)callback
                );
            }
        ...
        )
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                return __DSL_glfwSetDropCallback(
                    (Window*)__dsl_window,
                    (delegate* unmanaged<Window*, int, sbyte**, void>)callback
                );
            }
        ...
        )
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                return __DSL_glfwSetFramebufferSizeCallback(
                    (Window*)__dsl_window,
                    (delegate* unmanaged<Window*, int, int, void>)callback
                );
            }
        ...
        public static void SetGamma(PtrRef<Monitor, Monitor> monitor, float gamma)
        {
            fixed (Monitor* __dsl_monitor = monitor)
            {
                ...
                __DSL_glfwSetGamma((Monitor*)__dsl_monitor, (float)gamma);
            }
        }
        ...
        )
        {
            ...
            fixed (Monitor* __dsl_monitor = monitor)
            {
                ...
                __DSL_glfwSetGammaRamp((Monitor*)__dsl_monitor, (Gammaramp*)__dsl_ramp);
            }
        }
        ...
        public static void SetInputMode(PtrRef<Window, Window> window, int mode, int value)
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                __DSL_glfwSetInputMode((Window*)__dsl_window, (int)mode, (int)value);
            }
        }
        ...
        public static void SetJoystickUserPointer(int jid, PtrRef pointer)
        {
            fixed (void* __dsl_pointer = pointer)
            {
                ...
                __DSL_glfwSetJoystickUserPointer((int)jid, (void*)__dsl_pointer);
            }
        }
        ...
        )
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                return __DSL_glfwSetKeyCallback(
                    (Window*)__dsl_window,
                    (delegate* unmanaged<Window*, int, int, int, int, void>)callback
                );
            }
        ...
        public static void SetMonitorUserPointer(PtrRef<Monitor, Monitor> monitor, PtrRef pointer)
        {
            fixed (void* __dsl_pointer = pointer)
            fixed (Monitor* __dsl_monitor = monitor)
            {
                ...
                __DSL_glfwSetMonitorUserPointer((Monitor*)__dsl_monitor, (void*)__dsl_pointer);
            }
        }
        ...
        )
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                return __DSL_glfwSetMouseButtonCallback(
                    (Window*)__dsl_window,
                    (delegate* unmanaged<Window*, int, int, int, void>)callback
                );
            }
        ...
        )
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                return __DSL_glfwSetScrollCallback(
                    (Window*)__dsl_window,
                    (delegate* unmanaged<Window*, double, double, void>)callback
                );
            }
        ...
        public static void SetWindowAspectRatio(PtrRef<Window, Window> window, int numer, int denom)
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                __DSL_glfwSetWindowAspectRatio((Window*)__dsl_window, (int)numer, (int)denom);
            }
        }
        ...
        public static void SetWindowAttrib(PtrRef<Window, Window> window, int attrib, int value)
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                __DSL_glfwSetWindowAttrib((Window*)__dsl_window, (int)attrib, (int)value);
            }
        }
        ...
        )
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                return __DSL_glfwSetWindowCloseCallback(
                    (Window*)__dsl_window,
                    (delegate* unmanaged<Window*, void>)callback
                );
            }
        ...
        )
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                return __DSL_glfwSetWindowContentScaleCallback(
                    (Window*)__dsl_window,
                    (delegate* unmanaged<Window*, float, float, void>)callback
                );
            }
        ...
        )
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                return __DSL_glfwSetWindowFocusCallback(
                    (Window*)__dsl_window,
                    (delegate* unmanaged<Window*, int, void>)callback
                );
            }
        ...
        )
        {
            ...
            fixed (Window* __dsl_window = window)
            {
                ...
                __DSL_glfwSetWindowIcon((Window*)__dsl_window, (int)count, (Image*)__dsl_images);
            }
        }
        ...
        )
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                return __DSL_glfwSetWindowIconifyCallback(
                    (Window*)__dsl_window,
                    (delegate* unmanaged<Window*, int, void>)callback
                );
            }
        ...
        )
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                return __DSL_glfwSetWindowMaximizeCallback(
                    (Window*)__dsl_window,
                    (delegate* unmanaged<Window*, int, void>)callback
                );
            }
        ...
        public static void SetWindowOpacity(PtrRef<Window, Window> window, float opacity)
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                __DSL_glfwSetWindowOpacity((Window*)__dsl_window, (float)opacity);
            }
        }
        ...
        public static void SetWindowPos(PtrRef<Window, Window> window, int xpos, int ypos)
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                __DSL_glfwSetWindowPos((Window*)__dsl_window, (int)xpos, (int)ypos);
            }
        }
        ...
        )
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                return __DSL_glfwSetWindowPosCallback(
                    (Window*)__dsl_window,
                    (delegate* unmanaged<Window*, int, int, void>)callback
                );
            }
        ...
        )
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                return __DSL_glfwSetWindowRefreshCallback(
                    (Window*)__dsl_window,
                    (delegate* unmanaged<Window*, void>)callback
                );
            }
        ...
        public static void SetWindowShouldClose(PtrRef<Window, Window> window, int value)
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                __DSL_glfwSetWindowShouldClose((Window*)__dsl_window, (int)value);
            }
        }
        ...
        public static void SetWindowSize(PtrRef<Window, Window> window, int width, int height)
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                __DSL_glfwSetWindowSize((Window*)__dsl_window, (int)width, (int)height);
            }
        }
        ...
        )
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                return __DSL_glfwSetWindowSizeCallback(
                    (Window*)__dsl_window,
                    (delegate* unmanaged<Window*, int, int, void>)callback
                );
            }
        ...
        )
        {
            ...
            fixed (Window* __dsl_window = window)
            {
                ...
                __DSL_glfwSetWindowTitle((Window*)__dsl_window, (sbyte*)__dsl_title);
            }
        }
        ...
        public static void SetWindowUserPointer(PtrRef<Window, Window> window, PtrRef pointer)
        {
            fixed (void* __dsl_pointer = pointer)
            fixed (Window* __dsl_window = window)
            {
                ...
                __DSL_glfwSetWindowUserPointer((Window*)__dsl_window, (void*)__dsl_pointer);
            }
        }
        ...
        )
        {
            fixed (sbyte* __dsl_string = @string)
            {
                ...
                return __DSL_glfwUpdateGamepadMappings((sbyte*)__dsl_string);
            }
        }
        ...
        )
        {
            fixed (sbyte* __dsl_value = value)
            {
                ...
                __DSL_glfwWindowHintString((int)hint, (sbyte*)__dsl_value);
            }
        }
        ...
        public static int WindowShouldClose(PtrRef<Window, Window> window)
        {
            fixed (Window* __dsl_window = window)
            {
                ...
                return __DSL_glfwWindowShouldClose((Window*)__dsl_window);
            }
        }
    }
    ...
    [NativeFunction("glfw", EntryPoint = "glfwCreateCursor")]
    PtrRef<Cursor, Cursor> IGlfw.CreateCursor(
        [NativeTypeName("const GLFWimage *")] PtrRefToConst<Image, Image> image,
        int xhot,
        int yhot
    )
    ...
    [NativeFunction("glfw", EntryPoint = "glfwCreateStandardCursor")]
    PtrRef<Cursor, Cursor> IGlfw.CreateStandardCursor(int shape)
    {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwCreateWindow")]
    PtrRef<Window, Window> IGlfw.CreateWindow(
        int width,
        int height,
        [NativeTypeName("const char *")] PtrRefToConst<sbyte, sbyte> title,
        PtrRef<Monitor, Monitor> monitor,
    ...
    [NativeFunction("glfw", EntryPoint = "glfwDestroyCursor")]
    void IGlfw.DestroyCursor(PtrRef<Cursor, Cursor> cursor)
    {
        fixed (Cursor* __dsl_cursor = cursor)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwDestroyCursor")]
    public static void DestroyCursor(PtrRef<Cursor, Cursor> cursor) =>
        DllImport.DestroyCursor(cursor);

    [NativeFunction("glfw", EntryPoint = "glfwDestroyWindow")]
    void IGlfw.DestroyWindow(PtrRef<Window, Window> window)
    {
        fixed (Window* __dsl_window = window)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwDestroyWindow")]
    public static void DestroyWindow(PtrRef<Window, Window> window) =>
        DllImport.DestroyWindow(window);
    ...
    [NativeFunction("glfw", EntryPoint = "glfwFocusWindow")]
    void IGlfw.FocusWindow(PtrRef<Window, Window> window)
    {
        fixed (Window* __dsl_window = window)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwFocusWindow")]
    public static void FocusWindow(PtrRef<Window, Window> window) => DllImport.FocusWindow(window);

    [return: NativeTypeName("const char *")]
    [NativeFunction("glfw", EntryPoint = "glfwGetClipboardString")]
    PtrRefToConst<sbyte, sbyte> IGlfw.GetClipboardString(PtrRef<Window, Window> window)
    {
        fixed (Window* __dsl_window = window)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwGetCurrentContext")]
    PtrRef<Window, Window> IGlfw.GetCurrentContext()
    {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwGetCurrentContext")]
    public static PtrRef<Window, Window> GetCurrentContext() => DllImport.GetCurrentContext();
    ...
    )
    {
        ...
        fixed (Window* __dsl_window = window)
        {
            ...
            __DSL_glfwGetCursorPos((Window*)__dsl_window, (double*)__dsl_xpos, (double*)__dsl_ypos);
        }
    }
    ...
    [return: NativeTypeName("const char *")]
    [NativeFunction("glfw", EntryPoint = "glfwGetGamepadName")]
    PtrRefToConst<sbyte, sbyte> IGlfw.GetGamepadName(int jid)
    {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwGetGamepadName")]
    public static PtrRefToConst<sbyte, sbyte> GetGamepadName(int jid) =>
        DllImport.GetGamepadName(jid);

    [NativeFunction("glfw", EntryPoint = "glfwGetGamepadState")]
    int IGlfw.GetGamepadState(int jid, PtrRef<Gamepadstate, Gamepadstate> state)
    {
        fixed (Gamepadstate* __dsl_state = state)
        {
    ...
    [return: NativeTypeName("const GLFWgammaramp *")]
    [NativeFunction("glfw", EntryPoint = "glfwGetGammaRamp")]
    PtrRefToConst<Gammaramp, Gammaramp> IGlfw.GetGammaRamp(PtrRef<Monitor, Monitor> monitor)
    {
        fixed (Monitor* __dsl_monitor = monitor)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwGetInputMode")]
    int IGlfw.GetInputMode(PtrRef<Window, Window> window, int mode)
    {
        fixed (Window* __dsl_window = window)
        {
    ...
    [return: NativeTypeName("const float *")]
    [NativeFunction("glfw", EntryPoint = "glfwGetJoystickAxes")]
    PtrRefToConst<float, float> IGlfw.GetJoystickAxes(int jid, PtrRef<int, int> count)
    {
        fixed (int* __dsl_count = count)
        {
    ...
    [return: NativeTypeName("const unsigned char *")]
    [NativeFunction("glfw", EntryPoint = "glfwGetJoystickButtons")]
    PtrRefToConst<byte, byte> IGlfw.GetJoystickButtons(int jid, PtrRef<int, int> count)
    {
        fixed (int* __dsl_count = count)
        {
    ...
    [return: NativeTypeName("const char *")]
    [NativeFunction("glfw", EntryPoint = "glfwGetJoystickGUID")]
    PtrRefToConst<sbyte, sbyte> IGlfw.GetJoystickGuid(int jid)
    {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwGetJoystickGUID")]
    public static PtrRefToConst<sbyte, sbyte> GetJoystickGuid(int jid) =>
        DllImport.GetJoystickGuid(jid);

    [return: NativeTypeName("const unsigned char *")]
    [NativeFunction("glfw", EntryPoint = "glfwGetJoystickHats")]
    PtrRefToConst<byte, byte> IGlfw.GetJoystickHats(int jid, PtrRef<int, int> count)
    {
        fixed (int* __dsl_count = count)
        {
    ...
    [return: NativeTypeName("const char *")]
    [NativeFunction("glfw", EntryPoint = "glfwGetJoystickName")]
    PtrRefToConst<sbyte, sbyte> IGlfw.GetJoystickName(int jid)
    {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwGetJoystickName")]
    public static PtrRefToConst<sbyte, sbyte> GetJoystickName(int jid) =>
        DllImport.GetJoystickName(jid);

    [NativeFunction("glfw", EntryPoint = "glfwGetJoystickUserPointer")]
    PtrRef IGlfw.GetJoystickUserPointer(int jid)
    {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwGetJoystickUserPointer")]
    public static PtrRef GetJoystickUserPointer(int jid) => DllImport.GetJoystickUserPointer(jid);

    [NativeFunction("glfw", EntryPoint = "glfwGetKey")]
    int IGlfw.GetKey(PtrRef<Window, Window> window, int key)
    {
        fixed (Window* __dsl_window = window)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwGetKey")]
    public static int GetKey(PtrRef<Window, Window> window, int key) =>
        DllImport.GetKey(window, key);

    [return: NativeTypeName("const char *")]
    [NativeFunction("glfw", EntryPoint = "glfwGetKeyName")]
    PtrRefToConst<sbyte, sbyte> IGlfw.GetKeyName(int key, int scancode)
    {
    ...
    [return: NativeTypeName("const char *")]
    [NativeFunction("glfw", EntryPoint = "glfwGetMonitorName")]
    PtrRefToConst<sbyte, sbyte> IGlfw.GetMonitorName(PtrRef<Monitor, Monitor> monitor)
    {
        fixed (Monitor* __dsl_monitor = monitor)
        {
    ...
    )
    {
        ...
        fixed (Monitor* __dsl_monitor = monitor)
        {
            ...
            __DSL_glfwGetMonitorPos((Monitor*)__dsl_monitor, (int*)__dsl_xpos, (int*)__dsl_ypos);
        }
    }
    ...
    [NativeFunction("glfw", EntryPoint = "glfwGetMonitors")]
    PtrRef<Ptr<Monitor, Monitor>, Monitor> IGlfw.GetMonitors(PtrRef<int, int> count)
    {
        fixed (int* __dsl_count = count)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwGetMonitors")]
    public static PtrRef<Ptr<Monitor, Monitor>, Monitor> GetMonitors(PtrRef<int, int> count) =>
        DllImport.GetMonitors(count);

    [NativeFunction("glfw", EntryPoint = "glfwGetMonitorUserPointer")]
    PtrRef IGlfw.GetMonitorUserPointer(PtrRef<Monitor, Monitor> monitor)
    {
        fixed (Monitor* __dsl_monitor = monitor)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwGetMouseButton")]
    int IGlfw.GetMouseButton(PtrRef<Window, Window> window, int button)
    {
        fixed (Window* __dsl_window = window)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwGetPrimaryMonitor")]
    PtrRef<Monitor, Monitor> IGlfw.GetPrimaryMonitor()
    {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwGetPrimaryMonitor")]
    public static PtrRef<Monitor, Monitor> GetPrimaryMonitor() => DllImport.GetPrimaryMonitor();
    ...
    [return: NativeTypeName("const char **")]
    [NativeFunction("glfw", EntryPoint = "glfwGetRequiredInstanceExtensions")]
    PtrRefToConst<PtrToConst<sbyte, sbyte>, sbyte> IGlfw.GetRequiredInstanceExtensions(
        [NativeTypeName("uint32_t *")] PtrRef<uint, uint> count
    )
    {
        fixed (uint* __dsl_count = count)
    ...
    [NativeFunction("glfw", EntryPoint = "glfwGetVersion")]
    void IGlfw.GetVersion(PtrRef<int, int> major, PtrRef<int, int> minor, PtrRef<int, int> rev)
    {
        fixed (int* __dsl_rev = rev)
        fixed (int* __dsl_minor = minor)
        fixed (int* __dsl_major = major)
    ...
    [return: NativeTypeName("const char *")]
    [NativeFunction("glfw", EntryPoint = "glfwGetVersionString")]
    PtrRefToConst<sbyte, sbyte> IGlfw.GetVersionString()
    {
    ...
    [return: NativeTypeName("const char *")]
    [NativeFunction("glfw", EntryPoint = "glfwGetVersionString")]
    public static PtrRefToConst<sbyte, sbyte> GetVersionString() => DllImport.GetVersionString();

    [return: NativeTypeName("const GLFWvidmode *")]
    [NativeFunction("glfw", EntryPoint = "glfwGetVideoMode")]
    PtrRefToConst<Vidmode, Vidmode> IGlfw.GetVideoMode(PtrRef<Monitor, Monitor> monitor)
    {
        fixed (Monitor* __dsl_monitor = monitor)
        {
    ...
    [return: NativeTypeName("const GLFWvidmode *")]
    [NativeFunction("glfw", EntryPoint = "glfwGetVideoModes")]
    PtrRefToConst<Vidmode, Vidmode> IGlfw.GetVideoModes(
        PtrRef<Monitor, Monitor> monitor,
        PtrRef<int, int> count
    )
    {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwGetWindowAttrib")]
    int IGlfw.GetWindowAttrib(PtrRef<Window, Window> window, int attrib)
    {
        fixed (Window* __dsl_window = window)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwGetWindowMonitor")]
    PtrRef<Monitor, Monitor> IGlfw.GetWindowMonitor(PtrRef<Window, Window> window)
    {
        fixed (Window* __dsl_window = window)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwGetWindowOpacity")]
    float IGlfw.GetWindowOpacity(PtrRef<Window, Window> window)
    {
        fixed (Window* __dsl_window = window)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwGetWindowOpacity")]
    public static float GetWindowOpacity(PtrRef<Window, Window> window) =>
        DllImport.GetWindowOpacity(window);

    [NativeFunction("glfw", EntryPoint = "glfwGetWindowPos")]
    void IGlfw.GetWindowPos(
        PtrRef<Window, Window> window,
        PtrRef<int, int> xpos,
        PtrRef<int, int> ypos
    )
    ...
    )
    {
        ...
        fixed (Window* __dsl_window = window)
        {
            ...
            __DSL_glfwGetWindowSize((Window*)__dsl_window, (int*)__dsl_width, (int*)__dsl_height);
        }
    }
    ...
    [NativeFunction("glfw", EntryPoint = "glfwGetWindowUserPointer")]
    PtrRef IGlfw.GetWindowUserPointer(PtrRef<Window, Window> window)
    {
        fixed (Window* __dsl_window = window)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwHideWindow")]
    void IGlfw.HideWindow(PtrRef<Window, Window> window)
    {
        fixed (Window* __dsl_window = window)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwHideWindow")]
    public static void HideWindow(PtrRef<Window, Window> window) => DllImport.HideWindow(window);

    [NativeFunction("glfw", EntryPoint = "glfwIconifyWindow")]
    void IGlfw.IconifyWindow(PtrRef<Window, Window> window)
    {
        fixed (Window* __dsl_window = window)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwIconifyWindow")]
    public static void IconifyWindow(PtrRef<Window, Window> window) =>
        DllImport.IconifyWindow(window);
    ...
    [NativeFunction("glfw", EntryPoint = "glfwMakeContextCurrent")]
    void IGlfw.MakeContextCurrent(PtrRef<Window, Window> window)
    {
        fixed (Window* __dsl_window = window)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwMaximizeWindow")]
    void IGlfw.MaximizeWindow(PtrRef<Window, Window> window)
    {
        fixed (Window* __dsl_window = window)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwRequestWindowAttention")]
    void IGlfw.RequestWindowAttention(PtrRef<Window, Window> window)
    {
        fixed (Window* __dsl_window = window)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwRestoreWindow")]
    void IGlfw.RestoreWindow(PtrRef<Window, Window> window)
    {
        fixed (Window* __dsl_window = window)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwSetCursor")]
    void IGlfw.SetCursor(PtrRef<Window, Window> window, PtrRef<Cursor, Cursor> cursor)
    {
        fixed (Cursor* __dsl_cursor = cursor)
        fixed (Window* __dsl_window = window)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwSetCursorPos")]
    void IGlfw.SetCursorPos(PtrRef<Window, Window> window, double xpos, double ypos)
    {
        fixed (Window* __dsl_window = window)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwSetGamma")]
    void IGlfw.SetGamma(PtrRef<Monitor, Monitor> monitor, float gamma)
    {
        fixed (Monitor* __dsl_monitor = monitor)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwSetInputMode")]
    void IGlfw.SetInputMode(PtrRef<Window, Window> window, int mode, int value)
    {
        fixed (Window* __dsl_window = window)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwSetJoystickUserPointer")]
    void IGlfw.SetJoystickUserPointer(int jid, PtrRef pointer)
    {
        fixed (void* __dsl_pointer = pointer)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwSetMonitorUserPointer")]
    void IGlfw.SetMonitorUserPointer(PtrRef<Monitor, Monitor> monitor, PtrRef pointer)
    {
        fixed (void* __dsl_pointer = pointer)
        fixed (Monitor* __dsl_monitor = monitor)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwSetWindowAspectRatio")]
    void IGlfw.SetWindowAspectRatio(PtrRef<Window, Window> window, int numer, int denom)
    {
        fixed (Window* __dsl_window = window)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwSetWindowAttrib")]
    void IGlfw.SetWindowAttrib(PtrRef<Window, Window> window, int attrib, int value)
    {
        fixed (Window* __dsl_window = window)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwSetWindowOpacity")]
    void IGlfw.SetWindowOpacity(PtrRef<Window, Window> window, float opacity)
    {
        fixed (Window* __dsl_window = window)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwSetWindowPos")]
    void IGlfw.SetWindowPos(PtrRef<Window, Window> window, int xpos, int ypos)
    {
        fixed (Window* __dsl_window = window)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwSetWindowShouldClose")]
    void IGlfw.SetWindowShouldClose(PtrRef<Window, Window> window, int value)
    {
        fixed (Window* __dsl_window = window)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwSetWindowSize")]
    void IGlfw.SetWindowSize(PtrRef<Window, Window> window, int width, int height)
    {
        fixed (Window* __dsl_window = window)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwSetWindowUserPointer")]
    void IGlfw.SetWindowUserPointer(PtrRef<Window, Window> window, PtrRef pointer)
    {
        fixed (void* __dsl_pointer = pointer)
        fixed (Window* __dsl_window = window)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwShowWindow")]
    void IGlfw.ShowWindow(PtrRef<Window, Window> window)
    {
        fixed (Window* __dsl_window = window)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwShowWindow")]
    public static void ShowWindow(PtrRef<Window, Window> window) => DllImport.ShowWindow(window);

    [NativeFunction("glfw", EntryPoint = "glfwSwapBuffers")]
    void IGlfw.SwapBuffers(PtrRef<Window, Window> window)
    {
        fixed (Window* __dsl_window = window)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwSwapBuffers")]
    public static void SwapBuffers(PtrRef<Window, Window> window) => DllImport.SwapBuffers(window);
    ...
    [NativeFunction("glfw", EntryPoint = "glfwWindowShouldClose")]
    int IGlfw.WindowShouldClose(PtrRef<Window, Window> window)
    {
        fixed (Window* __dsl_window = window)
        {
    ...
    [NativeFunction("glfw", EntryPoint = "glfwWindowShouldClose")]
    public static int WindowShouldClose(PtrRef<Window, Window> window) =>
        DllImport.WindowShouldClose(window);
}

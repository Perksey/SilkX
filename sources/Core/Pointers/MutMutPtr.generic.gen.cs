	...
	where T : unmanaged
{
    ...
    public MutMutPtr(ref readonly MutPtr<T> @Ref)
    {
        IL.Emit.Ldarg_0();
        IL.Emit.Ldarg_1();
        IL.Emit.Stfld(
    ...
    private MutMutPtr(ref readonly byte @InteriorRef)
    {
    ...
    /// </summary>
    /// <param name="ptr"></param>
    public static implicit operator MutMutPtr(MutMutPtr<T> ptr) => new MutMutPtr(in ptr.InteriorRef);
}
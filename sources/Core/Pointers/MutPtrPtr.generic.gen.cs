	...
	where T : unmanaged
{
    ...
    public MutPtrPtr(ref readonly PtrPtr<T> @Ref)
    {
        IL.Emit.Ldarg_0();
        IL.Emit.Ldarg_1();
        IL.Emit.Stfld(
    ...
    private MutPtrPtr(ref readonly byte @InteriorRef)
    {
    ...
    /// </summary>
    /// <param name="ptr"></param>
    public static implicit operator MutPtrPtr(MutPtrPtr<T> ptr) => new MutPtrPtr(in ptr.InteriorRef);
}